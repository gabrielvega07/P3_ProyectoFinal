using culebrita.ClasesColas.ColaLista;
using System;
...
{
    internal class CulebritaColaCLista:CulebritaBase
    {
        public bool MoverLaCulebrita(ColaCLista culebra, Point posiciónObjetivo,
      int longitudCulebra, Size screenSize)
        ...
        public Point MostrarComida(Size screenSize, ColaCLista culebra)
        {
