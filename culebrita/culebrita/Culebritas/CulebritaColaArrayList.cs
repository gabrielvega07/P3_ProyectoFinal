using culebrita.ClasesColas.ColaArrayList;
using System;
...
{
    internal class CulebritaColaArrayList:CulebritaBase
    {
        ...
        public static Point MostrarComida(Size screenSize, ColaArrayList culebra)
        {
        ...
        {
            var punteo = 0;
            var velocidad = 100; //modificar estos valores y ver qué pasa milesegundos de espera
