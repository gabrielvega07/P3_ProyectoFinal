...
namespace culebrita.Culebritas
{
    internal class CulebritaBase
    {
        ...
        public static void DibujaPantalla(Size size)
        {
        ...
        public static void MuestraPunteo(int punteo)
        {
            Console.BackgroundColor = ConsoleColor.White;
        ...
        public static Direction ObtieneDireccion(Direction direccionAcutal)
        {
        ...
        public static Point ObtieneSiguienteDireccion(Direction direction, Point currentPosition)
        {
